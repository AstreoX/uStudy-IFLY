...
assert(!testPage.includes('class="assignment-banner"'), 'assignment detail still repeats teacher-assignment explanatory content')
assert(testPage.includes('option-item option-item-selected oj-web-hint'), 'OJ web hint does not reuse the standard quiz option styling')
assert(!testPage.includes('rgba(76, 48, 108'), 'assignment detail still contains the bespoke purple banner theme')
