          ...
          <transition name="menu-fade">
            <view v-if="accountMenuOpen" class="account-menu" :style="menuStyle">
              ...
              <view class="account-menu-item" @tap="handleSubscription">
                <svg viewBox="0 0 256 256" class="account-menu-icon"><rect width="256" height="256" fill="none"/><path d="M128,189.09l54.72,33.65a8.4,8.4,0,0,0,12.52-9.17l-14.88-62.79,48.7-42.53a8.37,8.37,0,0,0-4.79-14.7l-63.92-5.37L133.68,29.2a8.36,8.36,0,0,0-15.36,0L91.65,88.18,27.73,93.55a8.37,8.37,0,0,0-4.79,14.7l48.7,42.53L56.76,213.57a8.4,8.4,0,0,0,12.52,9.17Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
                <text class="account-menu-item-text">Subscription</text>
              </view>
              <view class="account-menu-item" @tap="handleSettings">
                ...
                <text class="account-menu-item-text">Settings</text>
              </view>
              <view class="account-menu-divider"></view>
